classdef MenuAPP_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        Ex2TextArea          matlab.ui.control.TextArea
        Ex1TextArea          matlab.ui.control.TextArea
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.APPMatlabAlgoritmosGenticosLabel.Layout.Column = [1 5];
            ...
            app.Exerccio1Button.BackgroundColor = [0.149 0.549 0.8667];
            ...
            app.Exerccio2Button.BackgroundColor = [0.149 0.549 0.8667];
            ...
            % Create Ex1TextArea
            app.Ex1TextArea = uitextarea(app.GridLayout);
            app.Ex1TextArea.HorizontalAlignment = 'center';
            app.Ex1TextArea.Layout.Row = 3;
            app.Ex1TextArea.Layout.Column = 2;
            app.Ex1TextArea.Value = {'EX1:'; ''; 'Determinação do mínimo e do máximo da função seno'; 'Recorrendo à Toolbox de Otimização do MATLAB'};

            % Create Ex2TextArea
            app.Ex2TextArea = uitextarea(app.GridLayout);
            app.Ex2TextArea.HorizontalAlignment = 'center';
            app.Ex2TextArea.Layout.Row = 3;
            app.Ex2TextArea.Layout.Column = 4;
            app.Ex2TextArea.Value = {'EX2:'; ''; 'Despacho económico sem perdas da rede multiplicadores de Lagrange. Recorrendo à Toolbox de Otimização do MATLAB'};
